...
type Props = {
  isDark?: boolean; // ${isDark ? "brightness-0" : ""} if background is "Dark", icon is white, If "Bright" is black
};
    ...
    <div className="flex justify-between items-center gap-7">
      <a href="https://twitter.com" target="_blank" rel="noreferrer">
        <Image
          ...
          // ${isDark ? "brightness-0" : ""} if background is "Dark", icon is white, If "Bright" is black
          alt="twitter"
          src={Twitter}
          width={20}
          height={20}
